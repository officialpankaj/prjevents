      ...
      <div className="container-fluid p-0">
        <div className="row servicebox">
          <div className="col-sm-6 service-imagebox">
            <img src="/images/services-image1.jpg" className="service-image" alt="service-image1" />
          </div>
          <div className="col-sm-6 service-detailbox">
            ...
            <div className="service-descriptionbox">
              ...
              <a href="../all-services/birthdays/">
                <div className="btn rounded-pill service-view-button">View Details</div>
              </a>
            </div>
          </div>
        </div>
        <div className="row servicebox" style={{ "background-color": "#f7f7f7" }}>
          <div className="col-sm-6 order-12 order-sm-first service-detailbox" style={{ padding: "8% 2.5% 8% 0%" }}>
            ...
            <div className="service-descriptionbox">
              ...
              <a href="../all-services/wedding/">
                <div className="btn rounded-pill service-view-button">View Details</div>
              </a>
            </div>
          </div>
          <div className="col-sm-6 service-imagebox">
            <img src="/images/services-image2.jpg" className="service-image" alt="services-image2" />
          </div>
        </div>
        <div className="row servicebox">
          <div className="col-sm-6 service-imagebox">
            <img src="/images/services-image3.jpg" className="service-image" alt="services-image3" />
          </div>
          <div className="col-sm-6 service-detailbox">
        ...
        <div className="row servicebox" style={{ "background-color": "#f7f7f7" }}>
          ...
          <div className="col-sm-6 service-imagebox">
            <img src="/images/services-image4.jpg" className="service-image" alt="services-image4" />
          </div>
        </div>
      </div>
